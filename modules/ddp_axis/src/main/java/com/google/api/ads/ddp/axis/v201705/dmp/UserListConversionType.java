...
public class UserListConversionType  implements java.io.Serializable {
    ...
    private com.google.api.ads.ddp.axis.v201705.dmp.UserListConversionTypeCategory category;
    ...
    public UserListConversionType(
           ...
           com.google.api.ads.ddp.axis.v201705.dmp.UserListConversionTypeCategory category) {
           this.id = id;
           this.name = name;
     ...
     * be ignored when sent to the API.</span>
     */
    public com.google.api.ads.ddp.axis.v201705.dmp.UserListConversionTypeCategory getCategory() {
        return category;
    }
     ...
     * be ignored when sent to the API.</span>
     */
    public void setCategory(com.google.api.ads.ddp.axis.v201705.dmp.UserListConversionTypeCategory category) {
        this.category = category;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/dmp/v201705", "UserListConversionType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/dmp/v201705", "category"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/dmp/v201705", "UserListConversionType.Category"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
