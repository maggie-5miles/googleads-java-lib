 ...
 *             client.
 */
public class InternalApiError  extends com.google.api.ads.ddp.axis.v201705.provider.ApiError  implements java.io.Serializable {
    /* The error reason represented by an enum. */
    private com.google.api.ads.ddp.axis.v201705.provider.InternalApiErrorReason reason;
    ...
    public InternalApiError(
           ...
           com.google.api.ads.ddp.axis.v201705.provider.InternalApiErrorReason reason) {
        super(
            fieldPath,
            fieldPathElements,
            trigger,
     ...
     */
    public com.google.api.ads.ddp.axis.v201705.provider.InternalApiErrorReason getReason() {
        return reason;
    }
     ...
     */
    public void setReason(com.google.api.ads.ddp.axis.v201705.provider.InternalApiErrorReason reason) {
        this.reason = reason;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/provider/v201705", "InternalApiError"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/provider/v201705", "InternalApiError.Reason"));
