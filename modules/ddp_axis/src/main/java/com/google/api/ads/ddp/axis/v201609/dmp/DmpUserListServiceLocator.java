...
public class DmpUserListServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.ddp.axis.v201609.dmp.DmpUserListService {
    ...
    private java.lang.String DmpUserListServiceInterfacePort_address = "https://ddp.googleapis.com/api/ddp/dmp/v201609/DmpUserListService";
    ...
    public com.google.api.ads.ddp.axis.v201609.dmp.DmpUserListServiceInterface getDmpUserListServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.ddp.axis.v201609.dmp.DmpUserListServiceInterface getDmpUserListServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.ddp.axis.v201609.dmp.DmpUserListServiceSoapBindingStub _stub = new com.google.api.ads.ddp.axis.v201609.dmp.DmpUserListServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.ddp.axis.v201609.dmp.DmpUserListServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.ddp.axis.v201609.dmp.DmpUserListServiceSoapBindingStub _stub = new com.google.api.ads.ddp.axis.v201609.dmp.DmpUserListServiceSoapBindingStub(new java.net.URL(DmpUserListServiceInterfacePort_address), this);
                _stub.setPortName(getDmpUserListServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/dmp/v201609", "DmpUserListService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://ddp.googleapis.com/api/ddp/dmp/v201609", "DmpUserListServiceInterfacePort"));
        }
